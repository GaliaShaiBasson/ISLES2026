...
`workspace/splits_full/{train,val}.csv`), each with `case_id, center,
...
def main() -> None:
    ...
    ap.add_argument("--train-csv", default="workspace/splits_full/train.csv", type=Path)
    ap.add_argument("--val-csv", default="workspace/splits_full/val.csv", type=Path)

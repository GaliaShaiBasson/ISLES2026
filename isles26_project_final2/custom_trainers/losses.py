"""Focal and Tversky losses used by the project trainer variants."""
...
class FocalLoss(nn.Module):
    """Softmax focal loss with foreground alpha for binary segmentation."""
...
class TverskyLoss(nn.Module):
    """Foreground Tversky loss; beta>alpha penalizes false negatives more strongly."""

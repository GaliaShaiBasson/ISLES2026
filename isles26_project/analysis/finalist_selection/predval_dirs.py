...
`analysis/finalist_selection/pca_probability_redundancy.py` (read-only
probability analysis), so both agree on where a trainer's val probabilities
actually live without duplicating the resolution logic.
...
(verified 2026-08-20: 120/120 cases, matching `splits_dataset002/val.csv`
